import requests
import json
from create_csv_log import log
...
def retrieve_confidence_with_transcription(transcription_result: dict) -> dict:
    ...
    return retrieve_transcription_with_highest_confidence(
        all_transcription_possible, {"confidence": 0}, {"confidence": 0}, 1
    )
...
def retrieve_transcription_with_highest_confidence(
    ...
    transcription_with_highest_confidence: dict,
    position: int ) -> dict:
    ...
    log(current_transcript, position)
    ...
    return retrieve_transcription_with_highest_confidence(
        all_transcriptions, current_transcript, transcription_with_highest_confidence, position+1 )
